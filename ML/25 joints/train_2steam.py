...
from data_helper import reduce_joint_dimension, create_model, reform_to_sequence, create_2steam_model
...
filepath="weight-2steam-{epoch:02d}-{val_accuracy:.2f}.hdf5"
...
for i_ep in range(start_epoch+1,num_epoch):
    ...
    print('epoch: ', i_ep)
    train_x, train_y, train_xdiff = reform_to_sequence(origin_train_x, origin_train_y, 20000, sequence_length, is_2steam=True)
